...
import { NavigationContext, WinesContext, NotificationContext } from '/src/utils/contexts/contexts'
...
function App() {
  ...
  <>
    ...
    <NotificationContext.Provider value={{notificationOn, setNotificationOn, hideNotification, setHideNotification, notificationText, setNotificationText, notificationColor, setNotificationColor}}> 
      <Navbar/>
